              ...
              <xsl:for-each select="RDF:RDF/RDF:Description/em:targetApplication">
                <em:targetApplication>
                  <RDF:Description>
                    ...
                    <em:updateLink>https://raw.github.com/friflaj/zotero-storage-scanner/master/<xsl:value-of select="$xpi"/></em:updateLink>

                    <em:updateInfoURL>https://github.com/friflaj/zotero-storage-scanner</em:updateInfoURL>
                  </RDF:Description>
                </em:targetApplication>
              </xsl:for-each>
            </RDF:Description>
